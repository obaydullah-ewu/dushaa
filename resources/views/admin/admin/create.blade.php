                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group mb-4 col-md-4">
                                            ...
                                            <div class="input-group input-group-solid">
                                                ...
                                                <input type="email" name="email" id="email" class="form-control form-control-solid" placeholder="Enter email" value="{{ old('email') }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group mb-4 col-md-4">
                                            <label class="required fw-bolder">Password</label>
                                            <div class="input-group input-group-solid">
                                                <input type="text" name="password" class="form-control form-control-solid" placeholder="Enter password" value="{{ old('password') }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group mb-4 col-md-4">
                                            <label class="required fw-bolder">Mobile Number</label>
                                            <div class="input-group input-group-solid">
                                                <input type="text" name="mobile_number" class="form-control form-control-solid" placeholder="Enter mobile number" value="{{ old('mobile_number') }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-4 col-md-4">
                                            ...
                                            <div class="input-group input-group-solid">
                                                <input type="text" name="address" class="form-control form-control-solid" placeholder="Enter address" value="{{ old('address') }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group mb-4 col-md-4">
                                            <label class="required fw-bolder">Designation</label>
                                            <div class="input-group input-group-solid">
                                                <input type="text" name="designation" class="form-control form-control-solid" placeholder="Enter designation" value="{{ old('designation') }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group mb-4 col-md-4">
