                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a href="{{ route('admin.setting.member-category.create') }}"
                            ...
                            @forelse($categories as $category)
                                ...
                                <tr class="ms-2">
                                    ...
                                    <td class="">
                                        <div class="d-flex ">
                                            <!--begin::Edit-->
                                            <a href="{{ route('admin.setting.member-category.edit', $category->id) }}"
                                            ...
                                            <!--start::Delete-->
                                            <button class="btn btn-icon btn-danger btn-action deleteItem" data-formid="delete_row_form_{{ $category->id }}">
                                            ...
                                            <form action="{{ route('admin.setting.member-category.destroy', $category->id) }}" method="post" id="delete_row_form_{{ $category->id }}">
                                                {{ method_field('DELETE') }}
