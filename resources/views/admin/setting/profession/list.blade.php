                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a href="{{ route('admin.setting.profession.create') }}"
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            @forelse($professions as $profession)
                                ...
                                <tr class="ms-2">
                                    ...
                                    <!--end::Checkbox-->
                                    <td><span class="text-gray-800">{{ $profession->name }}</span></td>
                                    <td class="">
                                        <div class="d-flex ">
                                            <!--begin::Edit-->
                                            <a href="{{ route('admin.setting.profession.edit', $profession->id) }}"
                                            ...
                                            <!--start::Delete-->
                                            <button class="btn btn-icon btn-danger btn-action deleteItem" data-formid="delete_row_form_{{ $profession->id }}">
                                            ...
                                            <form action="{{ route('admin.setting.profession.destroy', $profession->id) }}" method="post" id="delete_row_form_{{ $profession->id }}">
                                                {{ method_field('DELETE') }}
