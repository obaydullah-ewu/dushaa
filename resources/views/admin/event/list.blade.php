                                ...
                                <tr class="ms-2">
                                    ...
                                    <td class="">
                                        <div class="d-flex ">
                                            ...
                                            <!--start::Delete-->
                                            <button class="btn btn-icon btn-danger btn-action deleteItem" data-formid="delete_row_form_{{ $event->id }}">
                                            ...
                                            <form action="{{ route('admin.event.destroy', $event->id) }}" method="post" id="delete_row_form_{{ $event->id }}">
                                                {{ method_field('DELETE') }}
