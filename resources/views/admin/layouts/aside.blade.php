    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item menu-accordion">
                            <a href="{{ route('admin.admin.index') }}"
                               class="menu-link {{ @$subNavAdminIndexActiveCLass }}">
                            ...
                            <a href="{{ route('admin.admin.create') }}"
                               class="menu-link {{ @$subNavCreateAdminActiveCLass }}">
                                <span class="menu-bullet">
                ...
                <div class="menu-item">
                    <div class="menu-content pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Member Request</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link {{ @$subNavMemberRequestIndexActiveCLass }}" href="{{ route('admin.request-member.list') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    ...
                    <a class="menu-link {{ @$subNavEventRequestIndexActiveCLass }}" href="{{ route('admin.request-member.request-event.list') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ @$navSettingActiveCLass }}">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item menu-accordion">
                            <a href="{{ route('admin.setting.home-setting') }}"
                               class="menu-link {{ @$subNavHomeSettingActiveCLass }}">
                                <span class="menu-bullet">
                                   <i class="fas fa-list-ul"></i>
                                </span>
