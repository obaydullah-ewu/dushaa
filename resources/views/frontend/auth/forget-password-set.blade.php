                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            <div class="tabs-content">
                                <form action="{{ route('forget-password.otpCheck') }}" method="post">
                                    @csrf
                                    <div class="inputGroups">
                                        <label for="otp">Security Code (4 digit)</label>
                                        <input type="number" name="token" class="form-control" placeholder="Password" required />
                                    </div>
                                    ...
                                    <div class="inputGroups">
                                        ...
                                        <input type="password" name="confirmation_password" class="form-control" placeholder="Password" required />
                                    </div>
